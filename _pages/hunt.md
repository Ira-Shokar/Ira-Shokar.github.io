...
The scavenger hunt should take around 90 minutes to finish - if you need to take a break at any time that is fine, just send me a message saying, ``` 'Ereak' ```, so that I know that you want to continue after, and that you haven't given up.
